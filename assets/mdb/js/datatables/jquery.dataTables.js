...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 * function. With this function you can have a DataTables table go to the próximo,
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( lang ) {
			...
			if ( ! lang.sEmptyTable && zeroRecords &&
				defaults.sEmptyTable === "Nenhum dado disponível na tabela" )
			{
	...
	function _fnGetObjectDataFn( mSource )
	{
			      ...
			      mSource.indexOf('[') !== -1 || mSource.indexOf('(') !== -1) )
		{
			 ...
			 * nested object so we loop over the data for each level to get the próximo
	 ...
	 * the cached data is próximo requested. Also update from the data source object.
	 *
	 * @param {object} settings DataTables settings object
	...
	function _fnBuildAjax( oSettings, data, fn )
	{
		...
		else
		{
			...
			// Restore for próximo time around
			ajax.data = ajaxData;
		}
	}
	...
	function _fnScrollDraw ( settings )
	{
		...
		// Read all widths in próximo pass
	...
	function _fnSort ( oSettings )
	{
		...
		if ( _fnDataSource( oSettings ) != 'ssp' && aSort.length !== 0 )
		{
			 ...
			 * test the próximo column. If all columns match, then we use a numeric sort on the row
	...
	function _fnSortListener ( settings, colIdx, append, callback )
	{
		...
		var asSorting = col.asSorting;
		var nextSortIdx;
		var próximo = function ( a, overflow ) {
			var idx = a._idx;
			if ( idx === undefined ) {
		...
		if ( append && settings.oFeatures.bSortMulti ) {
			...
			if ( sortIdx !== -1 ) {
				// Yes, modify the sort
				nextSortIdx = próximo( sorting[sortIdx], true );
	 ...
	 *    * `próximo` - Jump to the próximo page
	...
	DataTable.models.oColumn = {
		 ...
		 * Sort it again (click again) and it will move on to the próximo index.
		 * Repeat until loop.
		 *  @type array
		 */
		"asSorting": null,
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 *
				 *  @dtopt Language
				 *  @name DataTable.defaults.language.paginate.próximo
				 *
				 *  @example
				 *    $(document).ready( function() {
				 *      $('#example').dataTable( {
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtrada de _MAX_ total de registros)",
	...
	DataTable.ext = _ext = {
		 ...
		 * * `próximo` - Show próximo page when activated
		 ...
		 *
		 *  @example
		 *    // Show anterior, próximo and current page buttons only
